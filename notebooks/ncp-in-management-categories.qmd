...
ggplot(ncp_lt_table, aes(y=NCP, x=LT)) +
  geom_tile(show.legend = T, alpha=0.75, fill=NA) +
...
cairo_ps(filename = "../figures/Figure_2.eps",
    width = 6.75,
    height = 4.75,
