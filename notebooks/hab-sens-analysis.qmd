...
With so many layers, there may be a "good enough" solution with much fewer layers. Here, we list the lowest AUC-EMD values for each possible number of inputs. A solution with fewer inputs is preferred computationally.
...
knitr::kable(auc_table, digits = 4, align="l",
             col.names = c("AUC-EMD", "Num Inputs", "Landscape Condition", "Terrestrial Species of Concern", "Wetland / Riparian", "Ecological Connectivity", "Ecological Integrity", "Terrestrial Resilience", "Biodiversity Value", "Habitat Quality"))
```
