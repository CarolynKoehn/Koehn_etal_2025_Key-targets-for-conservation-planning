...
all_layer_plot + 
  ...
  grid::textGrob(paste0("Cost:\n\U1F847", round(sol_diff_tbl_display["PercCostReduction", "no_food"], 0)*-1, "%")) +
  plot_spacer() +
  grid::textGrob(paste0("Crop\nProvision:\n\U1F847", round(sol_diff_tbl_display["PercCropProvReduction", "no_food"], 0)*-1, "%")) +
  grid::textGrob(paste0("Livestock\nCrop\nProvision:\n\U1F847", round(sol_diff_tbl_display["PercLvstckCropProvReduction", "no_food"], 0)*-1, "%")) +
  plot_spacer() +
  grid::textGrob(paste0("Agricultural\nPotential:\n\U1F847", round(sol_diff_tbl_display["PercPVRReduction", "no_food"], 0)*-1, "%")) +
  plot_layout(design=layout, 
              widths=c(1,1,1,1,1,0.5,1.3,-1.3,1),
...
all_layer_plot + 
  ...
  plot_spacer() +
  grid::textGrob(paste0("Cost:\n\U1F847", round(sol_diff_tbl_display["PercCostReduction", "no_climmit"], 0)*-1, "%")) +
  grid::textGrob(paste0("Soil\nOrganic\nCarbon:\n\U1F847", round(sol_diff_tbl_display["PercSOCReduction", "no_climmit"], 0)*-1, "%")) +
  plot_spacer() +
  grid::textGrob(paste0("Carbon\nStorage:\n\U1F847", round(sol_diff_tbl_display["PercCStorReduction", "no_climmit"], 0)*-1, "%")) +
  plot_layout(design=layout, 
              widths=c(1,1,1,1,0.8,0.2,2,-1.5,1))
```
...
cairo_ps(filename = "../figures/Figure_5.eps",
    ...
    height = 9,
    fallback_resolution = 1200)
print(all_layer_plot + no_food_plot + no_clim_plot + diff_plot_landuse + diff_plot_crops + diff_plot_tenure  + plot_layout(design=layout, widths=c(1,0.1,1)))
dev.off()
```
