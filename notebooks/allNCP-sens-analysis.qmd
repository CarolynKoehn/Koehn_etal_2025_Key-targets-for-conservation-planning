...
all_layer_plot + 
  ...
  plot_layout(design=layout, 
              widths=c(1,1,1,1,1,0.5,1.3,1),
              heights = rep(c(0.1,1,1), 3))
```
...
all_layer_plot + 
  ...
  plot_spacer() +
  grid::textGrob(paste0("Carbon\nStorage:\n\U1F847", round(sol_diff_tbl_display["PercCStorReduction", "no_food"], 0)*-1, "%")) +
  plot_layout(design=layout, 
              widths=c(1,1,1,1,1,0.5,1.3,-2,1))
```
